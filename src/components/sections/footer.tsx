...
const socialLinks = [
  ...
  {
    label: "Discord",
    href: "https://discord.gg/mtQG2FQsYA",
    icon: DiscordIcon,
  },
  {
    label: "Twitter",
...
function LinkedInIcon({ className }: { className?: string }) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.047c.476-.9 1.637-1.85 3.367-1.85 3.6 0 4.268 2.369 4.268 5.455v6.286zM5.337 7.433a2.062 2.062 0 1 1 0-4.125 2.062 2.062 0 0 1 0 4.125zM6.815 20.452H3.858V9h2.957v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.727v20.545C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.273V1.727C24 .774 23.2 0 22.222 0h.003z" />
    </svg>
  );
}
